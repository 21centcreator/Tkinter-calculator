...
e1=Entry(me,font=("Courier New",16,'bold'),textvar=textin,width=25,bd=5,bg='powder blue',justify=RIGHT)
e1.pack()
e1.insert(0,"0")
e1.config(state=DISABLED)
...
butdiv.config(fg='blue')

butclear=Button(me,padx=14,pady=119,bd=4,bg='white',text="CE",command=clrbut,font=("Courier New",16,'bold'))
butclear.place(x=270,y=100)

butequal=Button(me,padx=59,pady=14,bd=4,bg='white',command=equalbut,text="=",font=("Courier New",16,'bold'))
butequal.place(x=10,y=380)

butback=Button(me,padx=59,pady=14,bd=4,bg='white',command=funcdel,text="Del",font=("Courier New",16,'bold'))
butback.place(x=165,y=380)
